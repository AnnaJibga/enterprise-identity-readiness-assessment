...
*Context, assumptions, and positioning for the Enterprise Identity Readiness Assessment.*
...
- Establishing an honest baseline of institutional readiness before broad AI deployment
- Identifying which structural dimensions are foundational versus operational versus deployment-ready
- Surfacing the inverse pattern that is common in mature enterprises: strong governance and ownership built on top of weak foundational articulation
- Sequencing remediation work by dimension priority
- Providing a vocabulary for senior leadership conversations about AI readiness that goes beyond technical maturity

## What this assessment is not for

- **Not a one-time exercise.** Institutional logic shifts. Strategic priorities change. Domain concepts evolve. Re-assessment is essential.
- **Not a benchmark.** The output is a diagnostic against your own articulation, not a competitive ranking against peers.
- **Not a vendor selection tool.** A high readiness score does not tell you which AI to deploy. A low score does not tell you which AI to avoid.
- **Not a substitute for technical, data, or compliance assessments.** Those remain necessary in their own right.
- **Not a replacement for institutional dialogue.** The score is a starting point for leadership conversation, not a conclusion.

## Assumptions the assessment makes
...
The assessment is institutional, not technical. This distinction matters.

Most AI readiness assessments measure technical maturity (data quality, model capability, MLOps readiness, infrastructure, security). These are necessary and they are well-served by other instruments.

This assessment measures something different and upstream: whether the institution has articulated its logic clearly enough that AI can execute it without distorting it. An enterprise can have excellent technical AI readiness and poor institutional readiness; that combination produces AI that runs well technically but converges toward vendor defaults at the strategic level.

The two assessments answer different questions:

- *Technical readiness asks:* "Can we deploy AI?"
- *Institutional readiness asks:* "Should AI deployment preserve our distinctive logic, or will it erode it?"

Both questions matter. This assessment addresses the second.
...
This is **v1.0**, released April 2026. The version reflects the assessment's first formal public release on GitHub. Earlier circulation occurred through [foundationaldataproducts.com/tools](https://foundationaldataproducts.com/tools).

Version history is maintained in [CHANGELOG.md](./CHANGELOG.md).

## Permitted use

Under the [CC BY-NC-ND 4.0 license](./LICENSE), the assessment may be:

- Downloaded and run by any organization for internal use
- Cited and referenced in academic, professional, and commercial contexts with attribution
- Shared with attribution and without modification

It may not be:

- Used for commercial purposes (selling the assessment, embedding it in commercial products, charging fees to administer it) without prior written license
